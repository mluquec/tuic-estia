        ...
        <div class="content"></div>
        	...
        	<div class="alert alert-success">
        	 ...
        	 <div class="row">
			  ...
			  <div class="col-sm-4">
			  	<a href="/general/add" class="btn btn-sm btn-primary btn-create" role="button">New General Information</a>			  	
			  </div>
        	...
        	<display:table name="list" requestURI="${listURL} " pagesize="5" class="table" id="list">
        		...
        		<display:column property="typeCategory" title="Category Type"></display:column>
        		...
        		<display:column  title="Settings">
        			...
        			<a href="/general/update?id=${id}" onclick="selectobjID(${id})" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
        			<a href="/general/delete?id=${id}" onclick="selectobjID(${id})" class="btn btn-danger"><em class="fa fa-trash-o "></em></a> 
        		</display:column>
        	</display:table>	
