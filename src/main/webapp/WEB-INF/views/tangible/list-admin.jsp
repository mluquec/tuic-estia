        	 ...
        	 <display:table name="list" requestURI="${listURL} " pagesize="5"  class="table" id="list">
        		...
        		<display:column  title="Basic Information">
       			...
       			<display:column  title="Settings">
        			...
        			<a href="/tangible/update-admin?id=${id}" onclick="selectobjID(${id})" class="btn btn-primary"><span  class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a> 
        			<a href="/tangible/delete-admin?id=${id}" onclick="selectobjID(${id})" class="btn btn-danger"><span  class="pull-right hidden-xs showopacity glyphicon glyphicon-trash"></span></a> 
