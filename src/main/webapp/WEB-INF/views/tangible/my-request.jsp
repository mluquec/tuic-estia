        	 ...
        	 <display:table name="list" requestURI="${listURL} " pagesize="5"  class="table" id="list">
        		...
        		<display:column  title="Basic Information">
       			...
       			<display:column  title="Settings">
        			...
        			<a href="/tangible/my-requestview?id=${id}" onclick="selectobjID(${id})" class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="View"><span  class="pull-right hidden-xs showopacity glyphicon glyphicon-file"></span></a> 
